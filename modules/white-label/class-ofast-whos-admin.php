...
class Ofast_X_Whos_Admin
{
    ...
    public function enqueue_assets($hook)
    {
        ...
        wp_enqueue_style(
            'ofast-white-label',
            plugins_url('assets/css/white-label.css', __FILE__),
            array('ofast-tabs'),
            OFAST_X_VERSION
        );
        ...
        wp_enqueue_script(
            'ofast-white-label',
            plugins_url('assets/js/white-label.js', __FILE__),
            array('jquery', 'ofast-tabs'),
            OFAST_X_VERSION,
            true
        );
        ...
        wp_localize_script(
            ...
            'ofastWhiteLabel',
            array(
                'defaultRight' => empty($footer_settings['hide_wp_version']) ? '<em>Version X.X</em>' : '',
            )
        );
    }
